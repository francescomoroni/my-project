...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Titolo video */}
      <h1 onClick={nextSlide} className="fixed right-6 bottom-1/3 text-right sm:right-10 sm:top-1/2 text-white hover:text-white/80 sm:hover:line-through cursor-pointer uppercase sm:text-2xl ">{homepage[currentImageIndex].title}</h1>
